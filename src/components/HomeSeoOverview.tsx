    ...
    >
      <div className="mx-auto max-w-3xl">
        ...
        <p className="mx-auto mt-4 max-w-2xl text-center text-base leading-relaxed text-slate-600 md:text-lg">
          아이디어 단계부터 팀 구성, 협업, 완주 인증까지 한 플랫폼에서 이어 갈 수 있습니다. 아래에서{" "}
          <strong className="font-semibold text-slate-800">프로젝트 탐색</strong>,{" "}
          <strong className="font-semibold text-slate-800">팀 빌딩</strong>,{" "}
          <strong className="font-semibold text-slate-800">링크드인 연동 증명서</strong>가 어떻게
          연결되는지 살펴보세요.
        </p>

        <div className="mt-14 space-y-14">
          <article className="scroll-mt-24" id="project-explore">
            <h3 className="text-xl font-bold text-slate-900 md:text-2xl">프로젝트 탐색</h3>
            <div className="prose prose-slate mt-4 max-w-none text-slate-700 prose-p:leading-relaxed prose-a:text-blue-600">
              <p>
          ...
          <article className="scroll-mt-24" id="team-building">
            <h3 className="text-xl font-bold text-slate-900 md:text-2xl">팀 빌딩 시스템</h3>
            <div className="prose prose-slate mt-4 max-w-none text-slate-700 prose-p:leading-relaxed prose-a:text-blue-600">
              <p>
                팀장은 프로젝트를 등록하고 모집 역할·일정·소개를 작성해 팀을 열 수 있습니다. 지원자는
                프로필과 희망 포지션을 바탕으로 신청하고, 팀장은 지원 내역을 검토해 수락 여부를
                결정합니다. 수락된 멤버는{" "}
                <strong>전용 워크스페이스</strong>에 참여해 칸반 작업, 채팅, 공지 등으로 일정과 산출물을
                맞춰 갑니다.
              </p>
              <p>
                프로필의 매너 온도·기술 태그 등은 상호 이해를 돕는 참고 정보로 활용될 수 있으며, 협업
                종료 후에는 상호 피드백을 통해 다음 매칭과 성장에도 연결됩니다. 팀을 만들 준비가 되었다면{" "}
                <Link href="/signup">회원 가입</Link> 후 프로젝트를 등록해 보세요.
              </p>
            </div>
          </article>

          <article className="scroll-mt-24" id="linkedin-certificate">
            <h3 className="text-xl font-bold text-slate-900 md:text-2xl">링크드인 연동 증명서</h3>
            <div className="prose prose-slate mt-4 max-w-none text-slate-700 prose-p:leading-relaxed prose-a:text-blue-600">
              <p>
